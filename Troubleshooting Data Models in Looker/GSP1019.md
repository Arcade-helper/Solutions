...
## Create the View File Called `user_order_lifetime`
## Replace the Code of `user_order_lifetime.view` with the Given below Code
```
...
## 🎉 You Did It!  
You've successfully completed the **Troubleshooting Data Models in Looker**!  
